...
gramatica = {
    ...
    "RestoDeclaracao": [[";"], ["=", "Expressao", "@CHECAR_TIPO", ";"]],
    
    "Atribuicao": [["IDENTIFICADOR", "@SALVAR_ALVO", "=", "Expressao", "@CHECAR_TIPO", ";"]],
    ...
    "Fator": [["IDENTIFICADOR", "@TIPO_ID"], ["NUMERAL", "@TIPO_NUM"], ["LITERAL", "@TIPO_LIT"], ["(", "Expressao", ")"]]
}
...
def parser(tokens_lexico, tabela_ll1, terminais, conjuntos_follow):
    ...
    # pilha_escopos é uma lista de dicionários. Cada dicionário é o contexto de um bloco {}
    pilha_escopos = [{}]
    ...
    while len(pilha) > 0:
        ...
        # Se o topo da pilha for um marcador, o parser PAUSA a análise da fita
        if topo.startswith("@"):
        ...
        if topo == "EOF" and token_atual == "EOF":
            if teve_erros:
                ...
                print("\nSUCESSO ABSOLUTO: A sintaxe e a semântica do código estão perfeitas!")
